...
var User = /** @class */ (function () {
    function User(name, filename, browser) {
        var _this = this;
        this._name = name;
    ...
    User.prototype._runTest = function () {
        return __awaiter(this, void 0, void 0, function () {
            var testcafe, runner;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, testcafe_1.default)('localhost', 0, 0)];
                    case 1:
                        testcafe = _a.sent();
    ...
    User.prototype.runStage = function (stageName) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
