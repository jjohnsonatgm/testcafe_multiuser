...
var Scenario = /** @class */ (function () {
    ...
    Scenario.prototype.createUser = function (name, filename, browser) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new user_class_1.User(name, filename, browser)];
                    case 1:
                        user = _a.sent();
                        return [4 /*yield*/, this._users.set(name, user)];
                    case 2:
                        _a.sent();
    ...
    Scenario.prototype.initUser = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                user = this._users.get(name);
                if (!user) {
                    throw new Error("The user named ".concat(name, " could not be found"));
                }
                return [2 /*return*/, function stage(stageName) {
